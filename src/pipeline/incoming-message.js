 ...
 * allowSelf), from a contact other than the one being moderated, or without
 * text content. Media messages are skipped rather than passed through with
 * a placeholder, since they're out of scope for now (see docs/decisions.md
 * "Media messages are out of scope for now") — unlike
 * src/prototype/test-delete-for-me.js, which deletes unconditionally and
 ...
 */
export function extractIncomingMessage(msg, targetJid, allowSelf = false, type = 'notify') {
